...
public class NeoTextField extends JTextField {
    private static final long serialVersionUID = 1L;
    private String placeholder = "";
    private boolean focused;

    public NeoTextField(int columns) {
        super(columns);
        init();
    }

    public NeoTextField(String text, int columns) {
        super(text, columns);
        init();
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (!focused && getText().isEmpty() && placeholder != null && !placeholder.isEmpty()) {
